...
amo! {
    ...
    amoadd_b = (0x0, 0x00); amoswap_b = (0x0, 0x01); amomaxu_b = (0x0, 0x1c);
    amoadd_h = (0x1, 0x00); amoswap_h = (0x1, 0x01); amomin_h = (0x1, 0x10);
    amocas_b = (0x0, 0x05); amocas_h = (0x1, 0x05);
}
...
pub const fn wrs_sto() -> u32 {
    i(0x01d, 0, 0x0, 0, 0x73)
}
